...
| "Diafiltration clearance is exp(−N(1−σ)) where σ is the sieving coefficient." | Correct only if σ is the **rejection** coefficient. With σ read as sieving, a freely permeating salt never washes out, which is plainly wrong. [SRC-NOURAFKAN-2024], [SRC-KELLY-OPRD-2025] |
