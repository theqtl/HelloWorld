...
| **new question** | **In-line ultraviolet concentration measurement will saturate** on a 21-mer at process concentration; the path length implied is on the order of a few micrometres. **CORRECTED 2026-09-21:** this entry originally went on to say the deployed answer is variable-pathlength slope spectroscopy, "which is at-line, not in-line". That inference was WRONG and was carried into Q-042, control C-013 and a guard before it was caught. Variable-pathlength cells are used in-line on UF/DF in the peer-reviewed literature (SRC-ROLINGER-2023). The defensible claim is narrower: at our own registered retentate concentration the required path length falls below the published in-line floor, so the reading is at-line **on this stream**. See Q-042, Q-051, Q-052. |
